...
export const RecipeProvider = ({ children }) => {
    const recipes = [
        ...
        { id: 2, name: 'Chicken Tikka Masala', image: 'https://placehold.co/150x150', description: 'Delicious recipe' },
        { id: 3, name: 'Beef Stroganoff', image: 'https://placehold.co/150x150', description: 'Delicious recipe' }
      ];
